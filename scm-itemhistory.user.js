...
// @version      2.0
// @description  Shows links to item histories for items on the Steam Community Market. Not all items are in the chosen third party sites' database. TF2, CS:GO, and Dota 2 supported.
// @author       cares
...
function addLinks() {
    $J('.market_listing_row').each(function () {
        ...
        if (gameid === 440) { // TF2
            ...
            htm += '<small><a href="http://www.tf2outpost.com/item/730,' + id + '">TF2 Outpost</a></small>'
            + ' <small><a href="http://www.counterstrikeglobal.co.uk/item/' + id + '">CounterstrikeGlobal</a></small>';
        } else if (gameid === 570) {
